...
gulp.task('styles', function () {
  return sass('themes/basics/static/sass/styles.scss', {style: 'compressed'})
    ...
    .pipe(gulp.dest('themes/basics/static/css/'))
...
gulp.task('images', function () {
  return streamqueue({objectMode: true},
    gulp.src('themes/basics/static/img/**/*{.jpg, .png, .gif}')
      .pipe(cache(imagemin({optimizationLevel: 3, progressive: true, interlaced: true})))
      .pipe(notify({message: 'Images minifed.'})),
    gulp.src('themes/basics/static/img/**/*')
...
gulp.task('watch', function () {
  ...
  gulp.watch('themes/basics/static/sass/**/*.scss', ['styles']);

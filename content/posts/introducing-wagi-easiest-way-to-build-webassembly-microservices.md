...
Today, we are open sourcing another experimental WebAssembly effort: the [WebAssembly Gateway Interface (WAGI)](https://github.com/deislabs/wagi). Pronounced "waggy" (and inspired by some of the puppies on our team), WAGI is the easiest way to build WebAssembly microservices.
